...
namespace nativetouch_inject {
    ...
    // identify compatibility mouse messages generated by touch or pen input
    static bool is_touch_promoted_mouse_message() {
        constexpr ULONG_PTR MOUSE_INJECTED_SIGNATURE = 0xFF515700;
        constexpr ULONG_PTR MOUSE_INJECTED_SIGNATURE_MASK = 0xFFFFFF00;
        const auto extra_info = static_cast<ULONG_PTR>(GetMessageExtraInfo());
        return (extra_info & MOUSE_INJECTED_SIGNATURE_MASK) == MOUSE_INJECTED_SIGNATURE;
    }
    ...
    static LRESULT CALLBACK touch_window_subclass_proc(
        ...
        if (message >= WM_MOUSEFIRST && message <= WM_MOUSELAST &&
            is_touch_promoted_mouse_message()) {
            return 0;
        }
